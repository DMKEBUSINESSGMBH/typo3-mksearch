...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/hooks/class.tx_mksearch_hooks_EngineZendLucene.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/hooks/class.tx_mksearch_hooks_EngineZendLucene.php']);
}