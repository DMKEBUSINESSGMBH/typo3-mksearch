 ...
 */
class tx_mksearch_tests_model_IndexerDocumentBaseTest extends tx_mksearch_tests_Testcase
{
    public function testSetAbstractRemovesHtml(): void
    {
    ...
    public function testSetAbstractUsesGivenLengthEvenIfMaxAbstractLengthIsSet(): void
    {
        $indexerDocument = $this->getIndexerDocument();
    ...
    public function testSetAbstractUsesMaxAbstractLengthIfNoLengthGiven(): void
    {
        $indexerDocument = $this->getIndexerDocument();
    ...
    public function testSetAbstractHandlesMultiByteCharsCorrectWithGivenLength(): void
    {
        $indexerDocument = $this->getIndexerDocument();
     ...
     */
    private function getIndexerDocument(): object
    {
