...
class tx_mksearch_tests_filter_SolrBase_testcase extends tx_phpunit_testcase {
	...
	public function testAllowedFqParams(){
		...
		$this->assertEquals('-(fe_group_mi (-fe_group_mi:0))',$options['fq'],'fq wuede gesetzt!');
	}
	...
	public function testSettingOfFeGroupsToFilterQuery(){
		...
		$this->assertEquals('-(fe_group_mi (-fe_group_mi:0 OR -fe_group_mi:1 OR -fe_group_mi:2))',$options['fq'],'fq wuede gesetzt!');
