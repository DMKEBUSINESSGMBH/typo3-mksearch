 ...
 *          GNU Lesser General Public License, version 3 or later
 */
class tx_mksearch_tests_indexer_DamMedia_testcase
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/tests/indexer/class.tx_mksearch_tests_indexer_DamMedia_testcase.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/tests/indexer/class.tx_mksearch_tests_indexer_DamMedia_testcase.php']);
}
