...
class tx_mksearch_tests_indexer_TxNewsNewsTest extends tx_mksearch_tests_Testcase
{
    ...
    public function testHandleCategoryChanged(): void
    {
    ...
    public function testIndexData(): void
    {
        ...
        $this->assertIndexDocHasFields(
            ...
            [
                ...
                'pid' => '7',
                'tstamp' => (string) TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(TYPO3\CMS\Core\Context\Context::class)->getPropertyFromAspect('date', 'timestamp'),
                // news text ata
                'title' => 'first news',
    ...
    protected function getIndexerMock(array $newsRecord)
    {
        ...
        $indexer
            ...
            ->with(
                $newsRecord,
                'tx_news_domain_model_news',
                GeorgRinger\News\Domain\Repository\NewsRepository::class
            )
            ->willReturn($model)
        ;
