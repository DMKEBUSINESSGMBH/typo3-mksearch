 ...
 */
class tx_mksearch_tests_indexer_seminars_SeminarTest extends tx_mksearch_tests_DbTestcase
{
    /**
    ...
    public function testPrepareSearchDataWithTableSeminarsAndTypeIs0()
    {
        ...
        self::assertEquals([0 => '1304267200'], $aIndexDoc['begin_date_ms']->getValue(), 'Es wurde nicht der richtige Startzeitpunkt  indiziert!');
        self::assertEquals([0 => '1306287200'], $aIndexDoc['end_date_ms']->getValue(), 'Es wurde nicht der richtige Endzeitpunkt indiziert!');
        self::assertEquals([0 => '1. Kategorie', 1 => '2. Kategorie'], $aIndexDoc['categories_title_ms']->getValue(), 'Es wurden nicht die richtigen Kategorietitel indiziert!');
        self::assertEquals([0 => '1. Veranstalter'], $aIndexDoc['organizers_title_ms']->getValue(), 'Es wurden nicht die richtigen Veranstaltertitel indiziert!');
        self::assertEquals([0 => '1. Stadt', 1 => '2. Stadt'], $aIndexDoc['place_city_ms']->getValue(), 'Es wurden nicht die richtigen Städte indiziert!');
        self::assertEquals([0 => '1. Site', 1 => '2. Site'], $aIndexDoc['place_title_ms']->getValue(), 'Es wurden nicht die richtigen Titel der Sites indiziert!');
        self::assertEquals([0 => '1. Zielgruppe', 1 => '2. Zielgruppe'], $aIndexDoc['targetgroups_title_ms']->getValue(), 'Es wurden nicht die richtigen Zielgruppen indiziert!');
        self::assertEquals([0 => '1. Referent', 1 => '2. Referent'], $aIndexDoc['speakers_title_ms']->getValue(), 'Es wurden nicht die richtigen Sprechertitel indiziert!');
        self::assertEquals([0 => '1', 1 => '2'], $aIndexDoc['speakers_gender_ms']->getValue(), 'Es wurden nicht die richtigen Sprechergeschlechte indiziert!');
        self::assertEquals([0 => '1. Organisation', 1 => '2. Organisation'], $aIndexDoc['speakers_organization_ms']->getValue(), 'Es wurden nicht die richtigen Sprecherorganisationen indiziert!');
        self::assertEquals([0 => 'www.first.de', 1 => 'www.second.de'], $aIndexDoc['speakers_homepage_ms']->getValue(), 'Es wurden nicht die richtigen Sprecherhomepages indiziert!');
        self::assertEquals([0 => '1. Notizen', 1 => '2. Notizen'], $aIndexDoc['speakers_notes_ms']->getValue(), 'Es wurden nicht die richtigen Sprechernotizen indiziert!');
        self::assertEquals([0 => '1. Addresse', 1 => '2. Addresse'], $aIndexDoc['speakers_address_ms']->getValue(), 'Es wurden nicht die richtigen Sprecheradressen indiziert!');
        self::assertEquals([0 => '0001', 1 => '0005'], $aIndexDoc['speakers_phone_work_ms']->getValue(), 'Es wurden nicht die richtigen Sprechertelefon Arbeit indiziert!');
        self::assertEquals([0 => '0002', 1 => '0006'], $aIndexDoc['speakers_phone_home_ms']->getValue(), 'Es wurden nicht die richtigen Sprechertelefon zu Hause indiziert!');
        self::assertEquals([0 => '0003', 1 => '0007'], $aIndexDoc['speakers_phone_mobile_ms']->getValue(), 'Es wurden nicht die richtigen Sprechertelefon Mobil indiziert!');
        self::assertEquals([0 => '0004', 1 => '0008'], $aIndexDoc['speakers_fax_ms']->getValue(), 'Es wurden nicht die richtigen Sprecherfax indiziert!');
        self::assertEquals([0 => 'my@email.de', 1 => 'your@email.de'], $aIndexDoc['speakers_email_ms']->getValue(), 'Es wurden nicht die richtigen Sprecheremail indiziert!');
        self::assertEquals([0 => 'will be announced'], $aIndexDoc['timeslots_entry_date_ms']->getValue(), 'Es wurden nicht die richtigen Timeslot Entry Dates indiziert!');
        self::assertEquals([0 => '1. Site', 1 => '2. Site'], $aIndexDoc['timeslots_place_ms']->getValue(), 'Es wurden nicht die richtigen Timeslot Places indiziert!');
        self::assertEquals([0 => '1. Referent', 1 => '2. Referent'], $aIndexDoc['timeslots_speakers_ms']->getValue(), 'Es wurden nicht die richtigen Timeslot Speakers indiziert!');
    }
    ...
    public function testPrepareSearchDataWithTableSeminarsAndTypeIs1()
    {
        ...
        self::assertEquals([0 => '1304267200', 1 => '1304268200'], $aIndexDoc['begin_date_ms']->getValue(), 'Es wurde nicht der richtige Startzeitpunkt  indiziert!');
        self::assertEquals([0 => '1306287200', 1 => '1306288200'], $aIndexDoc['end_date_ms']->getValue(), 'Es wurde nicht der richtige Endzeitpunkt indiziert!');
        self::assertEquals([0 => '1. Kategorie', 1 => '2. Kategorie', 2 => '3. Kategorie'], $aIndexDoc['categories_title_ms']->getValue(), 'Es wurden nicht die richtigen Kategorietitel indiziert!');
        self::assertEquals([0 => '1. Veranstalter', 1 => '2. Veranstalter'], $aIndexDoc['organizers_title_ms']->getValue(), 'Es wurden nicht die richtigen Veranstaltertitel indiziert!');
        self::assertEquals([0 => '1. Zielgruppe', 1 => '2. Zielgruppe'], $aIndexDoc['targetgroups_title_ms']->getValue(), 'Es wurden nicht die richtigen Zielgruppen indiziert!');
        self::assertEquals([0 => '1. Stadt', 1 => '2. Stadt'], $aIndexDoc['place_city_ms']->getValue(), 'Es wurden nicht die richtigen Städte indiziert!');
        self::assertEquals([0 => '1. Site', 1 => '2. Site'], $aIndexDoc['place_title_ms']->getValue(), 'Es wurden nicht die richtigen Titel der Sites indiziert!');
        self::assertEquals([0 => '1. Referent', 1 => '2. Referent'], $aIndexDoc['speakers_title_ms']->getValue(), 'Es wurden nicht die richtigen Sprechertitel indiziert!');
