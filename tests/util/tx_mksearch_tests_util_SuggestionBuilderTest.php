...
{
    public function testBuildSuggestionsWithEmptyFacetData(): void
    {
        $suggestionData = [];
        ...
        self::assertTrue([] === $suggestionData, 'es wurde kein leeres array zurück gegeben!');
    }

    public function testBuildSuggestions(): void
    {
