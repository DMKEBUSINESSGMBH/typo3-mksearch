...
{
    public function testBuildFacetsWithEmptyFacetData(): void
    {
        $facetData = new stdClass();
        $facetData->facet_queries = null;
        $facetData->facet_fields = null;
        $facetData->facet_pivot = null;
        ...
        self::assertTrue([] === $facetData, 'es wurde kein leeres array zurück gegeben!');
    }

    public function testBuildFacetsWithQueryFacets(): void
    {
        $facetCount = new stdClass();
        $facetCount->facet_queries = $this->buildQueryFacets();
        $facetCount->facet_fields = null;
        $facetCount->facet_pivot = null;
    ...
    public function testBuildFacetsWithPivotFacets(): void
    {
        $facetCount = new stdClass();
        $facetCount->facet_pivot = $this->buildPivotFacets();
        $facetCount->facet_queries = null;
        $facetCount->facet_fields = null;
    ...
    public function testBuildFacetsWithFieldFacets(): void
    {
        $facetCount = new stdClass();
    ...
    public function testSortFacets(): void
    {
        $facets = [
            // field facets
            $this->getModel(
    ...
    private function buildFieldFacets(): stdClass
    {
        $facetData = new stdClass();
    ...
    private function buildQueryFacets(): stdClass
    {
        $facetData = new stdClass();
