...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/tests/fixtures/typo3/class.tx_mksearch_tests_fixtures_typo3_CoreDbRelationHandler.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/tests/fixtures/typo3/class.tx_mksearch_tests_fixtures_typo3_CoreDbRelationHandler.php']);
}