...
//		}
	...
	public function getBoost() {
		...
		if (is_array($val) && !is_array($this->_boost)) {
			$foo = array();
			for ($i=0; $i<count($val); $i++) $foo[] = $this->_boost;
			return $foo;
		}
		// else
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/model/class.tx_mksearch_model_IndexerFieldBase.php']) {
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/model/class.tx_mksearch_model_IndexerFieldBase.php']);
}