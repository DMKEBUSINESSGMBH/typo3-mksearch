...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/model/irfaq/class.tx_mksearch_model_irfaq_Expert.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/model/irfaq/class.tx_mksearch_model_irfaq_Expert.php']);
}