...
class tx_mksearch_search_irfaq_Question extends tx_rnbase_util_SearchBase {
	...
	protected function getTableMappings() {
		...
		tx_rnbase_util_Misc::callHook('mksearch','search_irfaq_Question_getTableMapping_hook',
	...
	protected function getJoins($tableAliases) {
		...
		// Hook to append other tables
		tx_rnbase_util_Misc::callHook('mksearch','search_irfaq_Question_getJoins_hook',
