...
class tx_mksearch_util_Config {
	...
	public static function getIndexerConfigs($extKey=null) {
		// All indexers
		if (!$extKey) return self::$indexerTableMappings;
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/util/class.tx_mksearch_util_Config.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/util/class.tx_mksearch_util_Config.php']);
}