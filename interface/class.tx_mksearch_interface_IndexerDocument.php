...
interface tx_mksearch_interface_IndexerDocument {
	 ...
	 * @param boolean $flat if true the key is returned as flat string.
	 * @return array[
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/interface/class.tx_mksearch_interface_IndexerDocument.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mksearch/interface/class.tx_mksearch_interface_IndexerDocument.php']);
}